    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<VehicleDto, Vehicle>()
                ...
                .ForMember(dest => dest.RegistrationNumber, opt => opt.MapFrom(src => string.IsNullOrWhiteSpace(src.RegistrationNumber) ? null : src.RegistrationNumber))
                .ForMember(dest => dest.EngineNumber, opt => opt.MapFrom(src => string.IsNullOrWhiteSpace(src.EngineNumber) ? null : src.EngineNumber))
                .ForMember(dest => dest.ChassisNumber, opt => opt.MapFrom(src => string.IsNullOrWhiteSpace(src.ChassisNumber) ? null : src.ChassisNumber))
